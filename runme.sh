...
export CLASSPATH="./lib/*:dist/lib/*:/Users/victorng/dev/hadoop-0.20.203.0/conf"
/usr/bin/env java com.mozilla.services.hdfs.LogReader -i fixtures/sample.json.log -hdfs_path /hdfs/var/log/metlog
